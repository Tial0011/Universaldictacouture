export const ADMIN_SECTIONS = [
  ...
  { path: "/admin/discovery", label: "Shop discovery", group: "Website content", description: "Guide customers to collections with occasion and style tiles.", action: "Manage discovery" },
