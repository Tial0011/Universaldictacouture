...
export default function ReviewsFeeds() {
  useDocumentMeta({ title: "Review & Feeds | Universal Dicta Couture", description: "Read published customer reviews from Universal Dicta Couture.", canonicalPath: "/reviews-feeds" });
  ...
  return <section className="account-page container"><div className="account-card"><h1>Review &amp; Feeds</h1>
