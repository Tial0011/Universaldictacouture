...
export default function MyCloset() {
  ...
  return <section className="account-page container"><div className="account-card"><h1>My Closet</h1><p>Your selected pieces for this browser session. Adding a piece does not place an order or make a payment.</p>
    ...
    <div className="account-actions"><Button to="/shop">Browse the shop</Button><Button to="/my-closet/my-pieces" variant="secondary">My Pieces</Button>{lines.length > 0 && <Button to="/chats" state={{ draft: closetEnquiry(lines) }} variant="secondary">Ask about these pieces</Button>}</div>
  </div></section>;
}
